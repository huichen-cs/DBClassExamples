...
public class MovieController {
    ...
    private static void printCustomerInvoice(Connection connection, String storeNo,
            String customerId) throws SQLException {
        MovieView.promptForTransactionNo();
        String transactionNo = in.next();
        Invoice invoice =
                MovieDataModel.getCustomerInvoiceByTransactionNo(connection, storeNo, customerId, transactionNo);
